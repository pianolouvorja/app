export default {
  starting: {
    titleFirstBoot: 'Configurando LouvorJA - PIANO',
    titleWarmBoot: 'Preparando LouvorJA - PIANO',
    subtitle: 'Estamos configurando y preparando todo para usted.',
    retry: 'Intentar de nuevo',
    status: {
      booting: 'Iniciando la aplicación…',
      ...
      retry: 'Intentando de nuevo…',
      error: 'No se pudo completar la preparación. Intente de nuevo.',
      errorOffline:
        'Sin conexión a internet. Verifique su red e intente de nuevo.',
      errorRateLimit:
