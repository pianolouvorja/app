export default {
  liturgy: {
    ...
    lockDeletions: 'Bloquear exclusões',
    unlockDeletions: 'Desbloquear exclusões',
    ...
    dialog: {
      ...
      momentName: 'Nome do Momento',
      momentNamePlaceholder: 'Ex: Louvor de Abertura',
