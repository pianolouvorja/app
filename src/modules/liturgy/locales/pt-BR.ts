export default {
  liturgy: {
    ...
    typeDescriptions: {
      ...
      audio: 'Arquivo de áudio local (MP3 e outros)',
      video: 'Vídeo local',
    ...
    fields: {
      ...
      presentationEngine: 'Motor de conversão',
    presentationEngineHint: 'Automático usa o PowerPoint quando instalado (formatação fiel). LibreOffice pode alterar a formatação de apresentações complexas.',
    engineCustom: 'Outro app…',
    ...
    selectPresentationButton: 'Selecione uma apresentação',
      ...
      fileDesktopOnly: 'Seleção de arquivos disponível apenas na versão desktop.',
      book: 'Livro',
      chapter: 'Capítulo',
      verses: 'Versículos',
