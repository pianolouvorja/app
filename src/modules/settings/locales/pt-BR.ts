export default {
  settings: {
    ...
    externalPlayer: {
      ...
      player: {
        associated: 'Player do sistema Piano',
        vlc: 'VLC',
        mpv: 'mpv',
        custom: 'Outro ({name})',
      },
      detect: 'Detectar players instalados',
      detecting: 'Detectando…',
      detectEmpty: 'Nenhum outro player de mídia foi encontrado neste computador.',
      detectFound: 'Players encontrados neste computador:',
      pickOther: 'Escolher outro player…',
      pickTitle: 'Escolha o executável do player de vídeo/áudio',
      removeCustom: 'Remover {name} da lista',
      hint: 'Use Detectar para listar os players instalados. Padrão: Player do sistema Piano (reprodução interna do app).',
    ...
    presentation: {
      ...
      detect: 'Detectar aplicativos instalados',
      detecting: 'Detectando…',
      detectEmpty: 'Nenhum aplicativo de apresentação foi encontrado neste computador.',
      detectFound: 'Aplicativos encontrados neste computador:',
      custom: 'Escolher outro aplicativo',
      customActive: 'Outro app (definido)',
      customAppTitle: 'Escolha o aplicativo de apresentação (Keynote, OnlyOffice, WPS…)',
      hint: 'Use Detectar para listar o que está instalado. Padrão: Automático (conversão interna do app).',
      desktopOnly: 'Disponível apenas no aplicativo desktop.',
    },
    youtube: {
      title: 'YouTube',
