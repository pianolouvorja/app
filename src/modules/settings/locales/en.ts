export default {
  settings: {
    ...
    general: {
      ...
      dataHint:
        'Removes the catalog, downloaded media and saved preferences in the app data folder (on Windows: C:\\ProgramData\\LouvorJA-PIANO, shared across users). The app will restart setup on next launch.',
