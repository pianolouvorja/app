export default {
  settings: {
    ...
    externalPlayer: {
      ...
      player: {
        associated: 'Piano system player',
        vlc: 'VLC',
        mpv: 'mpv',
        custom: 'Other ({name})',
      },
      detect: 'Detect installed players',
      detecting: 'Detecting…',
      detectEmpty: 'No other media players were found on this computer.',
      detectFound: 'Players found on this computer:',
      pickOther: 'Choose another player…',
      pickTitle: 'Select the video/audio player executable',
      removeCustom: 'Remove {name} from the list',
      hint: 'Use Detect to list installed players. Default: Piano system player (in-app playback).',
    ...
    presentation: {
      ...
      detect: 'Detect installed apps',
      detecting: 'Detecting…',
      detectEmpty: 'No presentation app was found on this computer.',
      detectFound: 'Apps found on this computer:',
      custom: 'Choose another application',
      customActive: 'Other app (set)',
      customAppTitle: 'Choose the presentation application (Keynote, OnlyOffice, WPS…)',
      hint: 'Use Detect to list installed apps. Default: Automatic (in-app conversion).',
      desktopOnly: 'Available on the desktop application only.',
    },
    youtube: {
      title: 'YouTube',
