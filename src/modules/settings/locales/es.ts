export default {
  settings: {
    ...
    general: {
      ...
      dataHint:
        'Elimina el catálogo, los medios descargados y las preferencias guardadas en la carpeta de datos de la app (en Windows: carpeta Data dentro de la instalación, compartida entre usuarios). La aplicación reiniciará la configuración en el próximo inicio.',
