export default {
  settings: {
    ...
    externalPlayer: {
      ...
      player: {
        associated: 'Reproductor del sistema Piano',
        vlc: 'VLC',
        mpv: 'mpv',
        custom: 'Otro ({name})',
      },
      detect: 'Detectar reproductores instalados',
      detecting: 'Detectando…',
      detectEmpty: 'No se encontró otro reproductor de medios en este equipo.',
      detectFound: 'Reproductores encontrados en este equipo:',
      pickOther: 'Elegir otro reproductor…',
      pickTitle: 'Selecciona el ejecutable del reproductor de video/audio',
      removeCustom: 'Quitar {name} de la lista',
      hint: 'Usa Detectar para listar los reproductores instalados. Predeterminado: Reproductor del sistema Piano (reproducción interna).',
    ...
    presentation: {
      ...
      detecting: 'Detectando…',
      detectEmpty: 'No se encontró ninguna aplicación de presentación en este equipo.',
      detectFound: 'Aplicaciones encontradas en este equipo:',
      custom: 'Elegir otra aplicación',
      customActive: 'Otra aplicación (definida)',
      customAppTitle: 'Elige la aplicación de presentación (Keynote, OnlyOffice, WPS…)',
      hint: 'Usa Detectar para listar lo instalado. Predeterminado: Automático (conversión interna).',
      desktopOnly: 'Disponible solo en la aplicación de escritorio.',
    },
    youtube: {
      title: 'YouTube',
