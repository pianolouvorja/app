 ...
 *
 * @returns {boolean} true se aceito, false caso contrário.
 */
...
function getEulaDir() {
	try {
		...
		// Fallback para testes onde electron app nao esta disponivel
 ...
 * Se já aceito, retorna true sem exibir dialog.
